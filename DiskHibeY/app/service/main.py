...
# -*- coding: utf-8 -*-
"""
DiskHibeY - DiskHibernation in fnOS for YYHome
...
APP_VERSION = "0.0.2"
DEFAULT_PORT = 8327
PORT = int(os.environ.get("DISKHIBEY_PORT", str(DEFAULT_PORT)))
    ...
    if _INDEX_CACHE["data"] is None:
        ...
        try:
            ...
            _INDEX_CACHE["data"] = ("<!DOCTYPE html><html lang=\"zh-CN\"><head><meta charset=\"utf-8\">"
                                    "<title>DiskHibeY</title></head><body>"
                                    "<h1>DiskHibeY</h1><p>前端页面缺失</p></body></html>").encode("utf-8")
    return _INDEX_CACHE["data"]


class Handler(BaseHTTPRequestHandler):
    server_version = "DiskHibeY/" + APP_VERSION
